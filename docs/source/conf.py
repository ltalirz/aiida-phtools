# -*- coding: utf-8 -*-
#
# Template file provided by the aiida-phtools; modify
...
release = aiida_phtools.__version__
...
html_use_opensearch = 'http://aiida-phtools.readthedocs.io'
...
htmlhelp_basename = 'aiida-phtools-doc'
